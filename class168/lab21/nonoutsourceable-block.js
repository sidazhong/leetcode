...
module.exports = class NonOutsourceableBlock extends Block {
  ...
  sign(privKey) {
    ...
    //
  	...
  	//sign the transactions and reward address using the same private key. 
  	//This second signature is stored in 'sig2'.
  ...
  hasValidProof() {
    ...
    //
  	...
  	//a valid preliminary proof 
  	//an additional signature (sig2)
  	if(this.hasValidPrelimProof() && this.sig2!==undefined){
  		return true;
  	}else{
  		return false;
  	}
