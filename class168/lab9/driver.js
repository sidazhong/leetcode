...
let asura = new Client({name: "Asura", net: fakeNet});
...
function showBalances(client) {
  ...
  console.log(`Asura has ${client.lastBlock.balanceOf(asura.address)} gold.`);
}
...
//bob transfers some money to charlie.
console.log(`Bob is transfering 40 gold to ${charlie.address}`);
bob.postTransaction([{ amount: 40, address: charlie.address }]);

//Alice transfers more money than she owns.
//console.log(`Alice is transfering 400 gold to ${charlie.address}`);
//alice.postTransaction([{ amount: 400, address: charlie.address }]);
